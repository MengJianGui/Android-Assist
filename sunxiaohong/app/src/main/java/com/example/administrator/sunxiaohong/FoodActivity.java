...
public class FoodActivity extends AppCompatActivity{
    ...
    private TextView tv_method1,tv_result1,tv_warning1,tv_advise1,tv_revise1,tv_reviseresult1;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SUCCESS:
                    ...
                    Toast.makeText(FoodActivity.this, "获取数据成功", Toast.LENGTH_SHORT)
                            .show();
                    break;

                case FAILURE:
                    Toast.makeText(FoodActivity.this, "获取数据失败", Toast.LENGTH_SHORT)
                            .show();
                    break;

                case ERRORCODE:
                    Toast.makeText(FoodActivity.this, "获取的CODE码不为200！",
    ...
    protected void init(){
        ...
        tv_advise1 = (TextView) findViewById(R.id.tv_advise1);
    ...
    public void setMessage(Map<String,String> message){
        ...
        tv_warning1.setText(message.get("warning"));
        tv_advise1.setText(message.get("advise"));

        tv_revise1.setText(message.get("alter"));
        tv_reviseresult1.setText(message.get("recom"));
    }
    ...
    private class PlayThread extends Thread{
        ...
        public void run(){
            int code;
            try {
                String path = "http://10.20.4.225:8080/client/api?command=foodInference&apikey=fPe2s6FbR5VeBQJuGBWIDHGxoHjo4IBBbfVwopVDctf1E9lyLemrGtFrmYAXWNxcTV-u2Choh2YQYV2RGhPdpQ&signature=g6WN588Bqxr7S0t2WAKmImcTfIg%3D";
                    ...
                    while(type!=XmlPullParser.END_DOCUMENT){
                        switch(type){
                            case XmlPullParser.START_TAG:
                                ...
                                if ("foodAndInferenceresponse".equals(startname)){
                                    ...
                                    String warning = xmlPullParser.nextText();
                                    listItem.put("warning",warning);
                                }else if ("advise".equals(startname)){
                                    String advise = xmlPullParser.nextText();
                                    listItem.put("advise",advise);
                                }else if ("alter".equals(startname)){
                                    String alter = xmlPullParser.nextText();
                                    listItem.put("alter",alter);
                                }else if ("recom".equals(startname)){
                                    String recom = xmlPullParser.nextText();
                                    listItem.put("recom",recom);
                                }
                                break;
