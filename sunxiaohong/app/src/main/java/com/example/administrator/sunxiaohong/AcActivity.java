...
public class AcActivity extends AppCompatActivity{
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case SUCCESS:
                    ...
                    Toast.makeText(AcActivity.this, "获取数据成功", Toast.LENGTH_SHORT)
                            .show();
                    break;

                case FAILURE:
                    Toast.makeText(AcActivity.this, "获取数据失败", Toast.LENGTH_SHORT)
                            .show();
                    break;

                case ERRORCODE:
                    Toast.makeText(AcActivity.this, "获取的CODE码不为200！",
    ...
    private class PlayThread extends Thread{
        ...
        public void run(){
            int code;
            try {
                String path = "http://10.20.4.225:8080/client/api?command=ACInference&apikey=fPe2s6FbR5VeBQJuGBWIDHGxoHjo4IBBbfVwopVDctf1E9lyLemrGtFrmYAXWNxcTV-u2Choh2YQYV2RGhPdpQ&signature=4LOl5i7ofm62f%2B1d3rTMd8qfcPM%3D";
                    ...
                    while(type!=XmlPullParser.END_DOCUMENT){
                        switch(type){
                            case XmlPullParser.START_TAG:
                                ...
                                if ("ACAndInferenceresponse".equals(startname)){
